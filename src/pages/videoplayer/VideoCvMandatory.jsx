                ...
                <Container maxWidth="lg" className='mt-5'>
                    ...
                    <Box sx={{ flexGrow: 1 }} className="mt-5">
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} md={6}>
                                <p className='text-bold text-dark'>What do we call this draft?</p>
                                <Box className="mt-3">
                                    <CssTextField
                                        id="outlined-basic"
                                ...
                                <Stack direction="row" justifyContent="space-between" className='mt-4'>
                                    <p className='text-bold text-dark'>Edit video</p>
                                ...
                                <Stack   direction={{ xs: 'column', sm: 'row', alignItems:"center" }}  spacing={2} className='mt-4'>
